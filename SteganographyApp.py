...
def main():
  ...
  mode = input("Type 'encode' if you would like to encode a message and type 'decode' if you would like to decode a message: ")
  if mode == "encode":
    myMsg = input("Type the message you would like to encode: ")
